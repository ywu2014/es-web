...
<html>
<head>
	<title>ES后台管理系统-首页</title>
	<%@include file="commonHeader.jspf" %>
    <link href="${ctx }/static/lib/hplus/css/plugins/iCheck/custom.css" rel="stylesheet">
    <link href="${ctx }/static/lib/hplus/css/plugins/fullcalendar/fullcalendar.css" rel="stylesheet">
    <link href="${ctx }/static/lib/hplus/css/plugins/fullcalendar/fullcalendar.print.css" rel="stylesheet">
</head>
<body class="gray-bg">
    ...
    <!-- 全局js -->
    <%@include file="globalScript.jspf" %>

    <!-- 自定义js -->
    <script src="${ctx }/static/lib/hplus/js/content.min.js?v=1.0.0"></script>
    <script src="${ctx }/static/lib/hplus/js/jquery-ui.custom.min.js"></script>

    <!-- iCheck -->
    <script src="${ctx }/static/lib/hplus/js/plugins/iCheck/icheck.min.js"></script>

    <!-- Full Calendar -->
    <script src="${ctx }/static/lib/hplus/js/plugins/fullcalendar/fullcalendar.min.js"></script>
